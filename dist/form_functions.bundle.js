...
/* harmony import */ var _DOM_functions_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./DOM_functions.js */ "./src/javascript/modules/DOM_functions.js");
  ...
  Promise.race([(0,_API_functions_js__WEBPACK_IMPORTED_MODULE_0__.getWeather)(citySearchInput.value), timeoutPromise(2000)])
    .then((data) => {
      if (data.error) {
        ...
        setTimeout(() => {
          (0,_DOM_functions_js__WEBPACK_IMPORTED_MODULE_1__.updateDomElements)(data);
          toggleLoadingState();
        }, 2000);
      }
    })
